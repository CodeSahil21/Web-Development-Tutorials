export const RevenueCard = ({
    ...
    return<div className = "bg-white rounded shadow-md p-2">
        <div className="text-gray-700 flex-justify-center flex-col">
         ...
         <div className="ml-1 pt-1 flex-justify-center flex-col "><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
